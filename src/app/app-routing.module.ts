...
const routes: Routes = [
    ...
    { path: 'danh-muc-du-an', component: TrangChuDuAnComponent, title: 'Danh mục dự án' },
    ...
    { path: 'chinh-sach-dai-ly-ctv', component: ChinhSachDaiLyCtvComponent, title: 'Chính sách đại lý CTV' },
    { path: 'du-an-khac', component: DuAnKhacComponent, title: 'Dự án khác' },
    { path: 'tuyen-dung', component: TuyenDungNewComponent, title: 'Tuyển dụng' },
